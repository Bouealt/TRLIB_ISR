...
class ISRServer {
public:
	static ISRServer* createNew(EventScheduler* scheduler, ThreadPool* threadPool, InetAddress& wifiAddr, InetAddress& lanAddr, std::vector<InetAddress> serverAddrs);
